...
/**
 * Sanitizes a CSS identifier to prevent CSS injection attacks.
 ...
 * Allows: hex colors, hsl/hsla, rgb/rgba, named colors, CSS variables.
 * Returns null for invalid/unsafe values.
 */
const sanitizeCssColor = (color: string): string | null => {
  ...
  // Allow hsl/hsla: hsl(0, 100%, 50%), hsla(0, 100%, 50%, 0.5)
  ...
  // Allow named colors (alphanumeric only, no special chars)
...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  // Security Note: This dangerouslySetInnerHTML usage is safe because:
  // 1. The `id` is sanitized via sanitizeCssIdentifier (alphanumeric only)
  // 2. Config keys are sanitized via sanitizeCssIdentifier
  // 3. Color values are validated via sanitizeCssColor (only safe CSS color formats)
  // 4. THEMES object is static and developer-controlled
  // This pattern is necessary for dynamic CSS variable injection in charts.
  return (
    <style
